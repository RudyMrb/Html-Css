...
<html>
  ...
  <body>
    ...
    ?>
    <section>
      <section id="Notre menu">
        <article class="">
          <h2>nos cuistots</h2>
          <h3>Nos Cuisto du code vous proposent une cuisine d'une grande variété comprenant des mets raffinés<br> et des plats de tous les types, ainsi que des recettes de saison innovantes selon les produits du web.
           <br>Venez vous en convaincre en jetant un œil sur nos plats du jour, notre carte et nos boissons..</h3>
        </article>
        <div class="">
      ...
      <section id="Menu">
        <article class="">
          <h2>menu</h2>
          <p><h3>La « frite » est un bâtonnet de pomme de terre cuit dans une graisse animale ou une huile végétale (friture). Les appellations pomme frite et patate frite sont utilisées indifféremment pour ce bâtonnet, pour une tranche ou pour une rondelle du même végétal cuit de cette façon.
